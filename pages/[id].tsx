...
export default function Details({ data }: any) {
  ...
  return (
    <div className='bg-MidAutumnBg h-screen flex flex-col items-center justify-center'>
      ...
      <h1 className="text-center text-3xl font-medium text-orange-200 mt-12 pt-0">您好 {Fname},</h1>
      ...
      {lottery_id ?
        ...
        : (<div>
          <h2 className="text-center text-2xl font-medium text-orange-200 mt-4">暂时没有抽奖号哦～请在主持人提示后刷新本页面</h2>
          <h2 className="text-center text-xl font-medium text-orange-200 pb-3">No lottery number available currently... Please refresh after host announcement. </h2>
        </div>)
      }
    </div>
  );
